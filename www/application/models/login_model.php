    ...
    class Login_model extends CI_Model {
        ...
        public function login($datos)
        {
    		...
    		$query = $this->db->query("
                                         ...
                                         CalleNumero, Colonia, CP,Ciudad,Estado,Administrador
                                         FROM Participante
                                         WHERE codPrograma = 43 AND codEmpresa = ".$emp." AND codParticipante = ".$part." AND pwd = '".$datos["password"]."'   AND Status = 1                                     
                                      ");
    		if ($query->num_rows() == 1)
    		{
